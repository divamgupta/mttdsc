    ...
    def build_model(self):
        ...
        def getM():
            ...
            def getPrimModel(): # will return a submodel with the shard weights and both the LSTMs
                ...
                left_x_2 = rnn_left_2( left_x)
                right_x_2 = rnn_right_2( right_x )
                ...
                left_x_2 = Lambda(lambda x:x[:,-1,:])( left_x_2 )
                right_x_2 = Lambda(lambda x:x[:,-1,:])( right_x_2 )

                x =  Concatenate()([ left_x_1 , right_x_1 , left_x_2 , right_x_2 ])    
                x = Dense( 3 )( x )
                out = Activation('softmax')( x )
